...
/*
 * aki2aki: simple utility that reads in a kidi file in ascii format
 *          and converts it to binary format. 
 * usage: 
 *           aki2aki infile.aki outfile.bki
 *
...
int main (int argc, char* argv[]) 
{
	...
	if (argc != 3)
	{
		fprintf(stderr, "Must have 2 arguments: infile.aki and outfile.aki\n");
		return 1;
	}
	...
	// Write the same data to a different file
